var systemComponents = {
	...
	'particle': {
		...
		template: `<div><div class='particle instant' v-bind:style="[constructParticleStyle(data), data.style]" 
			v-on:click="run(data.onClick, data)"  v-on:mouseenter="run(data.onMouseOver, data)"  v-on:mouseleave="run(data.onMouseLeave, data)"  v-on:mouseout="run(data.onMouseOut, data)" ><span v-html="data.text"></span>
		</div>
